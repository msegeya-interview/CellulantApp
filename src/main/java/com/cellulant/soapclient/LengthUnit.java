    ...
    extends Service
{
    ...
    public LengthUnitSoap getLengthUnitSoap12() {
        return super.getPort(new QName("http://www.webserviceX.NET/", "lengthUnitSoap12"), LengthUnitSoap.class);
    }
    ...
    public LengthUnitSoap getLengthUnitSoap12(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.webserviceX.NET/", "lengthUnitSoap12"), LengthUnitSoap.class, features);
    }
    ...
    public LengthUnitHttpGet getLengthUnitHttpGet() {
        return super.getPort(new QName("http://www.webserviceX.NET/", "lengthUnitHttpGet"), LengthUnitHttpGet.class);
    }
    ...
    public LengthUnitHttpGet getLengthUnitHttpGet(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.webserviceX.NET/", "lengthUnitHttpGet"), LengthUnitHttpGet.class, features);
    }
    ...
    public LengthUnitHttpPost getLengthUnitHttpPost() {
        return super.getPort(new QName("http://www.webserviceX.NET/", "lengthUnitHttpPost"), LengthUnitHttpPost.class);
    }
    ...
    public LengthUnitHttpPost getLengthUnitHttpPost(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.webserviceX.NET/", "lengthUnitHttpPost"), LengthUnitHttpPost.class, features);
    }
